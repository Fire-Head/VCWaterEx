...
RwInt32 &MatFXMaterialDataOffset = *(RwInt32*)0x7876CC;
RwInt32 &_rpMatFXMaterialDataFreeListBlockSize = *(RwInt32*)0x6DDCEC;
RwFreeList &_rpMatFXMaterialDataFreeList = *(RwFreeList*)0x7876A8;
...
void *MatFXGetData(RpMaterial *material, RpMatFXMaterialFlags materialFlag)
{
	 return ((void *(__cdecl *)(RpMaterial *, RpMatFXMaterialFlags))0x656520)(material, materialFlag);
}

RpMaterial *RpMatFXMaterialSetEnvMapFrame(RpMaterial *material, RwFrame *frame)
{
	((MatFXEnvMapData *)MatFXGetData(material, rpMATFXEFFECTENVMAP))->frame = frame;
...
{
	((MatFXEnvMapData *)MatFXGetData(material, rpMATFXEFFECTENVMAP))->coef = coef;
...
{
	((MatFXEnvMapData *)MatFXGetData(material, rpMATFXEFFECTENVMAP))->useFrameBufferAlpha = useFrameBufferAlpha;
