...
public:
	...
	{ }
	static Bool PreCalcWavySector(RwRGBA const &color)
	{ return true; }
...
CWaterLevel::RenderOneWavySector(float,float,float,RwRGBA const&,bool)
CWaterLevel::RenderWavyMask(float,float,float,float,float,float,float,float,float,RwRGBA const&)
*/